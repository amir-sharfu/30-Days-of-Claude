...
```mermaid
graph LR
    W1["🏗️ Phase 1\nFoundations\nDays 1–7"] --> W2["✍️ Phase 2\nPrompting\nDays 8–14"]
    W2 --> W3["🛠️ Phase 3\nUse Cases\nDays 15–21"]
    W3 --> W4["🚀 Phase 4\nAdvanced\nDays 22–28"]
    W4 --> W5["🎓 Phase 5\nProjects\nDays 29–30"]

    style W1 fill:#1a4d2e,color:#b2f2bb,stroke:#22c55e
    style W2 fill:#1e3a5f,color:#a5d8ff,stroke:#4a9eed
    style W3 fill:#5c3d1a,color:#ffd8a8,stroke:#f59e0b
    style W4 fill:#2d1b69,color:#d0bfff,stroke:#8b5cf6
    style W5 fill:#4a1942,color:#f9b4ed,stroke:#e879f9
```
...
graph TD
    ...
    G --> A["🔁 Keep Practising\nclaude.ai daily"]
    G --> B["📚 Go Deeper\nAdvanced prompting,\nClaude API"]
    G --> C["🛠️ Build Something\nClaude-powered\napplication"]
    G --> D["🤝 Teach Someone\nShare what you learned"]

    A --> A1["Pick one task per day\nand do it with Claude\ninstead of alone"]
    B --> B1["Anthropic documentation\nPrompt engineering guides\nClaude API reference"]
    C --> C1["Start with Track C\nfrom today's project"]
    D --> D1["The best way to\nsolidify learning is\nto explain it to others"]

    style G fill:#4a1942,color:#f9b4ed,stroke:#e879f9
    style A fill:#1a4d2e,color:#b2f2bb,stroke:#22c55e
    style B fill:#1e3a5f,color:#a5d8ff,stroke:#4a9eed
    style C fill:#5c3d1a,color:#ffd8a8,stroke:#f59e0b
    style D fill:#2d1b69,color:#d0bfff,stroke:#8b5cf6
```
